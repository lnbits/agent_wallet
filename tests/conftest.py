...
import agent_wallet.migrations as ext_migrations  # type: ignore[import]
from agent_wallet.crud import db  # type: ignore[import]
...
async def init_ext():
    ...
    async with db.connect() as conn:
        await run_migration(conn, ext_migrations, "agent_wallet")
